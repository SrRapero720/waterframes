...
public class ProjectorRenderer implements BlockEntityRenderer<BEProjector> {
    ...
    @Override
    public boolean shouldRender(BEProjector block, Vec3 vec) {
...
//        Vec3.atCenterOf(block.getBlockPos());
    ...
    @Override
    public void render(BEProjector block, float partialTicks, PoseStack pose, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
