package me.srrapero720.waterframes.client.screen;

import com.mojang.blaze3d.vertex.PoseStack;
import me.srrapero720.waterframes.WFConfig;
import me.srrapero720.waterframes.client.screen.widgets.WidgetTextField;
...
public class ProjectorScreen extends GuiLayer {
    ...
    public final GuiSyncLocal<CompoundTag> SET_DATA = getSyncHolder().register("set_data", nbt -> {
        ...
        if (WFConfig.canUse(getPlayer(), url)) {
            ...
            projector.renderDistance = Math.min(WFConfig.maxRenderDistance(), nbt.getInt("render"));
    ...
    public ProjectorScreen(BEProjector projector, int scaleSize) {
