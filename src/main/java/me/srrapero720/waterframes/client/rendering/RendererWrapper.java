...
public class RendererWrapper extends AbstractTexture {
    ...
    public RendererWrapper(final ImageRenderer imageRenderer) {
        ...
        for (int i = 0; i < this.glTextures.length; i++) {
            this.glTextures[i] = new GlTexture("texturewrapper_" + this.renderer.texture(i), TextureFormat.RGBA8, this.renderer.width, this.renderer.height, 1, this.renderer.texture(i)) {
