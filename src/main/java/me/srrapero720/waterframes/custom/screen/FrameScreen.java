...
public class FrameScreen extends GuiLayer {
    ...
    public void create() {
        ...
        range.add(new GuiSteppedSlider("range_min", (int) frame.minDistance, 0, WFConfig.maxAudioDistance()).setExpandableX());
        range.add(new GuiSteppedSlider("range_max", (int) frame.maxDistance, 1, WFConfig.maxAudioDistance()) {
            @Override
