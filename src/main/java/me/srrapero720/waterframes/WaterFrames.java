...
//    public static final WRegistry REGISTRY = new WRegistry(ID);
    ...
    public static RegistryObject<TileEntityType<TileFrame>> TILE_FRAME;
    ...
    public void register() {
        ...
        TILE_FRAME = TILES.register("frame", () -> TileEntityType.Builder.of(TileFrame::new, FRAME.get()).build(null));
