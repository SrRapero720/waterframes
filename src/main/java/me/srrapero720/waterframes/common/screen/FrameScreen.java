...
public class FrameScreen extends GuiLayer {
    ...
    public final GuiSyncLocal<CompoundTag> SET_DATA = getSyncHolder().register("set_data", nbt -> DataBlock.Frame.sync(frame, getPlayer(), nbt));

    public FrameScreen(BEFrame frame) {
    ...
    public void create() {
        ...
        GuiButton widgetSave = (GuiButton) new GuiButton("save", x -> SET_DATA.send(DataBlock.Frame.build(this)))
