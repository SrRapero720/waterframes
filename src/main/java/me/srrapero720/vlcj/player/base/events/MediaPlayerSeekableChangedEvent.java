...
import me.srrapero720.vlcj.binding.internal.media_player_seekable_changed;
...
final class MediaPlayerSeekableChangedEvent extends MediaPlayerEvent {
    ...
    MediaPlayerSeekableChangedEvent(MediaPlayer mediaPlayer, libvlc_event_t event) {
        super(mediaPlayer);
        this.newSeekable = ((media_player_seekable_changed) event.u.getTypedValue(media_player_seekable_changed.class)).new_seekable;
    }
