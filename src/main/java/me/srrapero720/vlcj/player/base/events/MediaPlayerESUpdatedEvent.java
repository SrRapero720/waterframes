 ...
 */
final class MediaPlayerESUpdatedEvent extends MediaPlayerEvent {
    ...
    MediaPlayerESUpdatedEvent(MediaPlayer mediaPlayer, libvlc_event_t event) {
        super(mediaPlayer);
    ...
    public void notify(MediaPlayerEventListener listener) {
        listener.elementaryStreamUpdated(mediaPlayer, TrackType.trackType(type), id, streamId);
    }
