...
import me.srrapero720.vlcj.binding.internal.media_player_program_changed;
 ...
 */
final class MediaPlayerProgramDeletedEvent extends MediaPlayerEvent {

    private final int id;

    MediaPlayerProgramDeletedEvent(MediaPlayer mediaPlayer, libvlc_event_t event) {
        super(mediaPlayer);
    ...
    public void notify(MediaPlayerEventListener listener) {
        listener.programDeleted(mediaPlayer, id);
    }
