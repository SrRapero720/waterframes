...
/**
 * Encapsulation of a media player finished event.
 */
final class MediaPlayerFinishedEvent extends MediaPlayerEvent {

    MediaPlayerFinishedEvent(MediaPlayer mediaPlayer) {
        super(mediaPlayer);
    }
