...
import me.srrapero720.vlcj.binding.internal.media_player_es_changed;
 ...
 */
final class MediaPlayerESDeletedEvent extends MediaPlayerEvent {
    ...
    MediaPlayerESDeletedEvent(MediaPlayer mediaPlayer, libvlc_event_t event) {
        super(mediaPlayer);
    ...
    public void notify(MediaPlayerEventListener listener) {
        listener.elementaryStreamDeleted(mediaPlayer, TrackType.trackType(type), id, streamId);
    }
