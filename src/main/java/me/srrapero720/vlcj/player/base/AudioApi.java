...
import me.srrapero720.vlcj.binding.support.strings.NativeString;
import me.srrapero720.vlcj.player.base.callback.AudioCallback;

import java.util.ArrayList;
import java.util.List;

import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_equalizer_get_band_count;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_equalizer_new;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_equalizer_release;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_equalizer_set_amp_at_index;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_equalizer_set_preamp;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_get_delay;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_get_mixmode;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_get_mute;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_get_stereomode;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_get_volume;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_output_device_enum;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_output_device_get;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_output_device_list_release;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_output_device_set;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_output_set;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_set_delay;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_set_mixmode;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_set_mute;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_set_stereomode;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_set_volume;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_audio_toggle_mute;
import static me.srrapero720.vlcj.binding.lib.LibVlc.libvlc_media_player_set_equalizer;
...
public final class AudioApi extends BaseApi implements EqualizerListener {
     ...
     * <p>
     * The output name comes from {@link me.srrapero720.vlcj.factory.AudioApi#audioOutputs()}.
     *
     ...
     * {@link me.srrapero720.vlcj.factory.AudioApi#audioOutputs()}.
     *
