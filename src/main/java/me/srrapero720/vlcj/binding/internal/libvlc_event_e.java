...
public enum libvlc_event_e {
    ...
    libvlc_MediaAttachedThumbnailsFound    (0x008),
    ...
    libvlc_MediaPlayerESUpdated            (0x11d),
    libvlc_MediaPlayerProgramAdded         (0x11e),
    libvlc_MediaPlayerProgramDeleted       (0x11f),
    libvlc_MediaPlayerProgramSelected      (0x120),
    libvlc_MediaPlayerProgramUpdated       (0x121),
    libvlc_MediaPlayerTitleListChanged     (0x122),
    libvlc_MediaPlayerTitleSelectionChanged(0x123),
    libvlc_MediaPlayerChapterChanged       (0x124),

    libvlc_MediaPlayerRecordChanged        (0x125),
